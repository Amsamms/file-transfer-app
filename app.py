...
def get_credentials():
    """Get Google credentials from service account (secrets or local file)."""
    creds = None
    ...
    if not creds:
        st.error("No credentials found! Please configure secrets or add service account file locally.")
        st.stop()
